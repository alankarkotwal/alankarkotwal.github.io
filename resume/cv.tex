...
\textbf{Dr. Sebastian Scherer}, Robotics Institute & \textbf{Prof. Mayank Vahia}, Astrophysics \\ 
Carnegie Mellon University & Tata Institute of Fundamental Research \\
\href{mailto:basti@andrew.cmu.edu}{\textcolor{blue}{E--Mail}} $|$ \href{http://www.ri.cmu.edu/person.html?person_id=1397}{\textcolor{blue}{Webpage}} & \href{mailto:vahia@tifr.res.in}{\textcolor{blue}{E--Mail}} $|$ \href{http://www.tifr.res.in/~vahia/}{\textcolor{blue}{Webpage}} \\
%\vspace{1pt} & \vspace{1pt} \\
%\textbf{Dr. Sebastian Scherer}, Systems Scientist & \textbf{Prof. Mayank Vahia}, Astrophysics \\ 
%Robotics Institute, Carnegie Mellon University & Tata Institute of Fundamental Research \\
%\href{mailto:anikets@hbcse.tifr.res.in}{\textcolor{blue}{E--Mail}} $|$ \href{http://www.hbcse.tifr.res.in/people/academic/aniket-sule}{\textcolor{blue}{Webpage}} & \href{mailto:vahia@tifr.res.in}{\textcolor{blue}{E--Mail}} $|$ \href{http://www.tifr.res.in/~vahia/}{\textcolor{blue}{Webpage}} \\
\end{tabular}
\end{resume}
\end{document}