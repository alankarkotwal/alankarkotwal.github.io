...
\vspace{1pt} & \vspace{1pt} \\
\textbf{Prof. Rajbabu Velmurugan}, EE & \\ % \textbf{Dr. Aniket Sule}, Astronomy \\ 
Indian Institute of Technology, Bombay & \\ % Homi Bhabha Center for Science Education \\
\href{mailto:rajbabu@ee.iitb.ac.in}{\textcolor{blue}{E--Mail}} $|$ \href{https://www.ee.iitb.ac.in/web/faculty/homepage/rajbabu}{\textcolor{blue}{Webpage}} & \\ % \href{mailto:anikets@hbcse.tifr.res.in}{\textcolor{blue}{E--Mail}} $|$ \href{http://www.hbcse.tifr.res.in/people/academic/aniket-sule}{\textcolor{blue}{Webpage}} \\
\end{tabular}
\end{resume}
\end{document}