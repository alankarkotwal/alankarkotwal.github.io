...
\end{itemize}
\textit{Paper "JOINT DESMOKING AND DENOISING OF LAPAROSCOPY IMAGES USINGPROBABILISTIC GRAPHICAL MODELING WITH BAYESIAN INFERENCE" submitted to the International Symposium on Biomedical Imaging (ISBI), 2016}
}
