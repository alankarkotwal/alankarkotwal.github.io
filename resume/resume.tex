...
\end{itemize}
\textit{Paper "Joint De-smoking and Denoising of Laparoscopy Images Using Bayesian Image Modeling and Inference" to be submitted to the International Symposium on Biomedical Imaging (ISBI), 2016}
}
...
\cvitem{\textbf{Physics and Maths}}{The General Theory of Relativity, Electromagnetic Waves, Electricity and Magnetism, Classical Mechanics, Differential Equations, Linear Algebra, Complex Analysis, Calculus}
